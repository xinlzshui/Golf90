const translations = {
  en: {
    home: "Home",
    learn: "Golf Swing Learning",
    privacy: "Privacy Policy",
    download: "Download App",
    heroTitle: "Master Your Swing with On-Device AI",
    heroSub: "Record, compare, and auto-clip your golf swings instantly. 100% local processing for ultimate privacy.",
    featuresTitle: "Core Features",
    f1Title: "Real-Time Camera Analysis",
  ...
  "zh-TW": {
    ...
    privacy: "隱私政策",
    download: "下載 App",
    heroTitle: "透過本地端 AI 掌控您的揮桿",
    heroSub: "即時錄製、對比並自動剪輯揮桿動作。100% 本地運算，保障隱私。",
    featuresTitle: "核心功能",
    f1Title: "即時拍攝分析",
  ...
  ko: {
    ...
    privacy: "개인정보 처리방침",
    download: "앱 다운로드",
    heroTitle: "온디바이스 AI로 스윙 마스터하기",
    heroSub: "스윙을 녹화하고 비교하며 자동으로 클립을 생성합니다. 100% 로컬 처리로 개인정보를 보호합니다.",
    featuresTitle: "핵심 기능",
    f1Title: "실시간 카메라 분석",
  ...
  ja: {
    ...
    privacy: "プライバシーポリシー",
    download: "アプリをダウンロード",
    heroTitle: "オンデバイスAIでスイングをマスター",
    heroSub: "スイングの録画、比較、自動切り抜きを瞬時に。100%ローカル処理でプライバシーを保護します。",
    featuresTitle: "主な機能",
    f1Title: "リアルタイム撮影分析",
  ...
  fr: {
    home: "Accueil",
    learn: "Apprentissage du Swing",
    privacy: "Confidentialité",
    download: "Télécharger",
    heroTitle: "Maîtrisez votre swing avec l'IA locale",
    heroSub: "Enregistrez, comparez et coupez automatiquement vos swings. Traitement 100% local.",
    featuresTitle: "Fonctionnalités",
    f1Title: "Analyse vidéo en temps réel",
  ...
  de: {
    home: "Startseite",
    learn: "Schwung lernen",
    privacy: "Datenschutz",
    download: "App laden",
    heroTitle: "Meistern Sie Ihren Schwung mit lokaler KI",
    heroSub: "Schwünge aufnehmen, vergleichen und automatisch zuschneiden. 100% lokale Verarbeitung.",
    featuresTitle: "Kernfunktionen",
    f1Title: "Echtzeit-Kameraanalyse",
  ...
  es: {
    home: "Inicio",
    learn: "Aprender Swing",
    privacy: "Privacidad",
    download: "Descargar App",
    heroTitle: "Domina tu swing con IA en el dispositivo",
    heroSub: "Graba, compara y recorta automáticamente tus swings. Procesamiento 100% local.",
    featuresTitle: "Características",
    f1Title: "Análisis en tiempo real",
  ...
  it: {
    home: "Home",
    learn: "Impara lo Swing",
    privacy: "Privacy",
    download: "Scarica App",
    heroTitle: "Domina il tuo swing con l'IA locale",
    heroSub: "Registra, confronta e ritaglia automaticamente i tuoi swing. Elaborazione 100% locale.",
    featuresTitle: "Funzionalità",
    f1Title: "Analisi in tempo reale",
